...
#define __mcode__Y2Y(x, a, b)       __asm x a, b 
#define __mcode__m2Y(x, a, b)       __asm x a, b 
#define __mcode__Y2m(x, a, b)       __asm x a, b 
/**-----------__masm------------------------------------*/
...
#define masm__Y2Y(x, a, b)       __asm  __mcode__Y2Y(x, a, b)
#define masm__m2Y(x, a, b)       __asm  __mcode__m2Y(x, a, b)
#define masm__Y2m(x, a, b)       __asm  __mcode__Y2m(x, a, b)
...
#define __mcode__Y2Y(x, a, b)        Str(x) " %%" Str(b) ", %%" Str(a) "; " 
#define __mcode__m2Y(x, a, m)        Str(x) " (%0), %%" Str(a) "; " 
#define __mcode__Y2m(x, m, b)        Str(x) " %%" Str(b) ",(%0); " 
/*--------------------masm__-----------------------------------------------------------*/
...
#define masm__Y2Y(x, a, b)       __asm__(__mcode__Y2Y(x, a, b)      :::);
#define masm__m2Y(x, a, m)       __asm__(__mcode__m2Y(x, a, m)      ::"r"(m):);
#define masm__Y2m(x, m, b)       __asm__(__mcode__Y2m(x, m, b)      ::"r"(m):);
/*---------------------------Addressing------------------------------------------------*/
...
#ifdef X64
#define __gcde_g(x, a)      Str(x) "q %%" Str(a) ";"
